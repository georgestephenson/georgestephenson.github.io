...
<section class="hero">
  ...
  <div class="hero-body">
    ...
    <p class="hero-lede">
      ...
      global companies. I lead architecture, modernise legacy codebases, and ship
      complex integrations — while mentoring the developers who
      keep them running.
    </p>
...
<ol class="timeline timeline-lead">
  <li>
    ...
    <div class="timeline-main">
      ...
      <p>Building an onshore development team from scratch and leading the re-platforming
      of an enterprise .NET Framework solution to .NET&nbsp;10 on Azure with microservices
      and message-driven architecture. Established automated testing (XUnit, Vitest,
      Playwright) and Azure DevOps CI/CD, and pioneered spec-driven AI development
